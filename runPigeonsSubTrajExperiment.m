function runPigeonsSubTrajExperiment(typeDistanceTerrain,chosenNorm,startIndex,endIndex)
% Load data for the pigeons from file.
readData = 0;
if ~readData
    [trajA, trajB] = loadPigeonData();
...
trajA = trajA(startIndex:endIndex, :);
trajB = trajB(startIndex:endIndex, :);
...
% Generate file names.
pathToResults = 'results/pigeons_subtraj/';
