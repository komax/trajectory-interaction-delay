 ...
 * @author max
 */
public class TripletTrajectoryReader {
    private Trajectory trajectory1;
    private Trajectory trajectory2;
    private Trajectory trajectory3;
    private final BufferedReader inputReader;
    
    public static TripletTrajectoryReader createTrajectoryReader(String fileName, boolean skipHeader) throws Exception {
        return new TripletTrajectoryReader(fileName, skipHeader);
    }
    
    public TripletTrajectoryReader(String fileName, boolean skipHeader) throws Exception {
    ...
    private void readTrajectories(boolean skipHeader) throws IOException {
        ...
        this.trajectory3 = new Trajectory();
        ...
        while ((currentLine = inputReader.readLine()) != null) {
            ...
            double[] pointsTraject3 = new double[2];
...
//                System.err.println(lineElements[1] + "|" + lineElements[2] + "|" + lineElements[3] + "|" + lineElements[4] + "|" + lineElements[5]);
                ...
                pointsTraject3[0] = Double.parseDouble(lineElements[6]);
                pointsTraject3[1] = Double.parseDouble(lineElements[7]);
            } else {
//                System.err.println(lineElements[0] + "|" + lineElements[1] + "|" + lineElements[2] + "|" + lineElements[3] + "|" + lineElements[4]);
                ...
                pointsTraject3[0] = Double.parseDouble(lineElements[5]);
                pointsTraject3[1] = Double.parseDouble(lineElements[6]);
            }
            trajectory1.addPoint(pointsTraject1);
            trajectory2.addPoint(pointsTraject2);
            trajectory3.addPoint(pointsTraject3);
        }
    }
    ...
    public Trajectory getTrajectory3() {
        return trajectory3;
    }
